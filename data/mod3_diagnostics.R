  ...
  moduleServer(id, function(input, output, session) {
    ...
    create_report_template <- function(results) {
      ...
      HTML(paste0(
        ...
        "<ul>",
        "<li>Factor Loading threshold: <strong>0.3 to 0.4</strong> is common, and <strong>0.33</strong> is a valid practical default<br>",
        "<em>Note: Higher thresholds (e.g., 0.5 or 0.6) are stricter and may remove more items</em></li>",
        "<li>Communality threshold: <strong>0.2 to 0.4</strong> is common, with <strong>0.3</strong> as a practical default<br>",
        "<em>Note: Variables with communalities below this range may be less well-represented in the factor solution</em></li>",
        "</ul>",
